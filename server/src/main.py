...
async def entrypoint(ctx: JobContext):
    ...
    # Session Creation
    interaction_mode, slug, selected_agent, language, persona, phone_number = (
    ...
    voiceGender = agent["gender"]
    speakerName = agent["voice"]
    ...
    session = AgentSession[SupportState](
        ...
        tts=sarvam.TTS(
            ...
            speech_sample_rate=8000 if is_phone_call else 22050,
            min_buffer_size=30,
            max_chunk_length=50,
        ),
